...
class $ScheduleTableTable extends ScheduleTable
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, startTime, endTime, content, date, categoryId, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class ScheduleTableData extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, startTime, endTime, content, date, categoryId, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      ...
      _scheduleTableRefsTable(_$AppDatabase db) =>
          MultiTypedResultKey.fromTable(db.scheduleTable,
              aliasName: $_aliasNameGenerator(
                  db.categoryTable.id, db.scheduleTable.categoryId));
...
final class $$ScheduleTableTableReferences extends BaseReferences<_$AppDatabase,
  ...
  static $CategoryTableTable _categoryIdTable(_$AppDatabase db) =>
      db.categoryTable.createAlias($_aliasNameGenerator(
          db.scheduleTable.categoryId, db.categoryTable.id));
              ...
              addJoins: <
                ...
                if (categoryId) {
                  state = state.withJoin(
                    ...
                    referencedTable:
                        $$ScheduleTableTableReferences._categoryIdTable(db),
                    referencedColumn:
                        $$ScheduleTableTableReferences._categoryIdTable(db).id,
                  ) as T;
                }
